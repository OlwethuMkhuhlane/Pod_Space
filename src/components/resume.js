    ...
    render() {
        ...
        <Grid>
          <Cell col={4}>
            ...
            <p>I can program in a few of the well-known programming languages such as Python, CSS, HTML, JavaScript and Java. I am quite fond of problem solving and translating those solutions to programs that can be used practically.</p>
            <hr style={{borderTop: '3px solid #833fb2', width: '50%'}}/>
            <h5>Address</h5>
